 ...
 */
export async function generateRecipesFromPantry(ingredientsList) {
  try {
    // We utilize gemini-3-flash as it is lightning fast and keeps responses under 5 seconds
    ...
    const prompt = `
      ...
      Phase 2 (Recipe Generation): If valid, generate 3 to 5 realistic recipes ranked by how well the provided ingredients match.
    ...
    throw new Error("Failed to communicate with our culinary core. Check your API key or network connection.");
  }
}